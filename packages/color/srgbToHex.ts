...
import { ColorBinaryFormat, srgbToInteger } from './srgbToInteger'
 ...
 * @example rgbToString({ r: 0x11, g: 0x22, b: 0x33, a: 0.5 }) // '#112233'
 */
export function srgbToHex(srgb: Partial<sRGB>, format: ColorBinaryFormat = 'rgba'): string {
  const hex = srgbToInteger(srgb, format).toString(16)
