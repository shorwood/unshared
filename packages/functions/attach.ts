...
if (import.meta.vitest) {
  it('should attach the "this" paramater to the first parameter of a function', () => {
    ...
    expect(called).toEqual('Hello, I am Joe')
    expect(fn).toHaveBeenCalledWith(object)
    expectTypeOf(result).toEqualTypeOf<(this: { name: string }) => string>()
  })

  it('should attach the "this" paramater to the first parameter of a function with multiple parameters', () => {
  ...
  it('should not attach the "this" paramater if the function does not have any parameters', () => {
