...
describe('distanceJaroWinkler', () => {
  const implementations = [['native', distanceJaroWinklerJS], ['binding', distanceJaroWinklerCC]] as const

  for (const [implementation, distanceJaroWinkler] of implementations) {
