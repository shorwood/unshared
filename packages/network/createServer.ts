import type { MaybeArray } from '@unshared/types/MaybeArray'
import type { Http2Server, Http2ServerRequest, Http2ServerResponse, SecureServerOptions, ServerOptions } from 'node:http2'
import type { RouteHandler, RouteName } from './createServerRoute'
import { rejects } from 'node:assert'
import { connect, constants, createServer as createHttpServer, createSecureServer as createHttpsServer } from 'node:http2'
