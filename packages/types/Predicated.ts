...
if (import.meta.vitest) {
  test('should infer string from a predicator for strings', () => {
    type Result = Predicated<(value: unknown) => value is string>
    expectTypeOf<Result>().toEqualTypeOf<string>()
  })

  test('should infer number from a predicator for numbers', () => {
    type Result = Predicated<(value: unknown) => value is number>
    expectTypeOf<Result>().toEqualTypeOf<number>()
  })

  test('should infer unknown from a predicator for unknowns', () => {
  ...
  test('should match function with more than one parameter', () => {
