...
export const SCALE_DATA_VOLUME_LONG = {
  ...createScale(['bits'], { factors: FACTOR_BASE10_LONG_BIG }),
  ...createScale(['bytes', 'octets'], { factors: FACTOR_BASE2_LONG }),
  ...createScale(['bytes', 'octets'], { factors: FACTOR_BASE10_LONG_BIG }),
} as const
