...
export const SCALE_ENERGY = {
  ...
  ...createScale('joule', { factors: FACTOR_BASE10_LONG }),

  // --- Electronvolt.
  ...createScale('eV', { factors: FACTOR_BASE10_SHORT, baseValue: 1.602176634e-19 }),
  ...createScale('electronvolt', { factors: FACTOR_BASE10_LONG, baseValue: 1.602176634e-19 }),
  ...
  ...createScale('newton-meter', { factors: FACTOR_BASE10_LONG }),
  ...createScale('watt-second', { factors: FACTOR_BASE10_LONG }),
  ...createScale('watt-hour', { factors: FACTOR_BASE10_LONG, baseValue: 3600 }),
  ...
  ...createScale('tonne TNT equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 41840000000 }),
  ...createScale('tonne oil equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 41840000000 }),
  ...createScale('tonne coal equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 293071070000 }),
  ...createScale('tonne diesel equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 41840000000 }),
  ...createScale('tonne natural gas equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 116415321826 }),
  ...createScale('tonne biodiesel equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 41840000000 }),
  ...createScale('tonne bioethanol equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 41840000000 }),
  ...createScale('barrel oil equivalent', { factors: FACTOR_EQUIVALENTS_LONG, baseValue: 5861520000 }),
