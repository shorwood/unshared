export interface UnpluginGuardTypesOptions {
   ...
   * @default false
   */
  castNumber?: boolean | Array<'bigint' | 'boolean' | 'string' | 'undefined' | 'null'>
  /**
   ...
   * @default false
   */
  castBoolean?: boolean | Array<'bigint' | 'number' | 'string' | 'undefined' | 'null'>
  /**
   ...
   * @default false
   */
  castString?: boolean | Array<'bigint' | 'boolean' | 'number' | 'undefined' | 'null'>
}
