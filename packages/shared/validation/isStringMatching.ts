...
/**
  ...
  */
export const isStringTimestamp = (value: string): boolean => /^(?![+-]?\d{4,5}-?(?:\d{2}|w\d{2})t)(?:|(\d{4}|[+-]\d{5})-?(?:|(0\d|1[0-2])(?:|-?([0-2]\d|3[01]))|([0-2]\d{2}|3[0-5]\d|36[0-6])|w([0-4]\d|5[0-3])(?:|-?([1-7])))(?:(?!\d)|t(?=\d)))(?:|([01]\d|2[0-4])(?:|:?([0-5]\d)(?:|:?([0-5]\d)(?:|\.(\d{3})))(?:|z|([+-](?:[01]\d|2[0-4]))(?:|:?([0-5]\d)))))$/i.test(value)
