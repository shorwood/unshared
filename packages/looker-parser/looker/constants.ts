 ...
 * dictionary key. For example, LookML can have multiple dimensions, so the parser
 ...
 */
export const QUOTED_LITERAL_KEYS = [
  'label',
  'view_label',
  'group_label',
  'group_item_label',
 ...
 */
export const KEYS_WITH_NAME_FIELDS = [
  'user_attribute_param',
  'param',
  'form_param',
  'option',
