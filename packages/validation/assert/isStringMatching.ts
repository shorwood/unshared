 ...
 * @example isStringMatching('Hello, World!', /Hello, \w+!/) // void
 */
export function isStringMatching(value: unknown, exp: RegExp): asserts value is string {
  isString(value)
...
if (import.meta.vitest) {
  test('should pass if value is a string matching a regular expression', () => {
    const result = isStringMatching('Hello, World!', /Hello, \w+!/)
    expect(result).toBeUndefined()
  })

  test('should throw if value is not a string', () => {
    const shouldThrow = () => isStringMatching(1, /Hello, \w+!/)
  ...
  test('should throw if value does not match the regular expression', () => {
    const shouldThrow = () => isStringMatching('Hello, World!', /Hello, \d+!/)
    expect(shouldThrow).toThrow(ValidationError)
  ...
  test('should throw if value is undefined', () => {
    ...
    const shouldThrow = () => isStringMatching(undefined, /Hello, \w+!/)
    expect(shouldThrow).toThrow(ValidationError)
  ...
  test('should throw if value is null', () => {
    ...
    const shouldThrow = () => isStringMatching(null, /Hello, \w+!/)
    expect(shouldThrow).toThrow(ValidationError)
  ...
  test('should predicate a string matching a regular expression', () => {
    ...
    isStringMatching(value, /Hello, \w+!/)
