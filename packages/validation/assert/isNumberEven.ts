 ...
 * @example isNumberEven(2) // true
 */
export function isNumberEven(value: unknown): asserts value is number {
  isNumber(value)
...
if (import.meta.vitest) {
  ...
  test('should throw if value is an odd number', () => {
    const shouldThrow = () => isNumberEven(1)
  ...
  test('should throw if value is a decimal number', () => {
    const shouldThrow = () => isNumberEven(2.1)
    expect(shouldThrow).toThrow(ValidationError)
  ...
  test('should throw if value is undefined', () => {
    ...
    const shouldThrow = () => isNumberEven(undefined)
    expect(shouldThrow).toThrow(ValidationError)
  ...
  test('should throw if value is null', () => {
    ...
    const shouldThrow = () => isNumberEven(null)
    expect(shouldThrow).toThrow(ValidationError)
