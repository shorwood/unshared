...
import { setSpacing } from '../components/setSpacing'
...
export interface BoxOptions {
   ...
   */
  padding?: [top: number, right: number, bottom: number, left: number] | [w: number, h: number] | number
   ...
   */
  margin?: [top: number, right: number, bottom: number, left: number] | [w: number, h: number] | number
