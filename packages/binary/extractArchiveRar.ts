/**
 * Extracts the content of a Rar archive into a map of `BinaryLike` values and their
 ...
 *
 * @param archive The Rar archive to extract.
 * @param options The options to use.
 * @returns A map of file paths to binary-like contents.
 * @example
 * const readStream = fs.createReadStream('archive.rar')
 * const entries = extractArchiveRar(readStream)
 *
