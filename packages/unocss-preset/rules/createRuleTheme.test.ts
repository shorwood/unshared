...
describe('createRuleTheme', () => {
  ...
  it('should generate CSS variables for theme', () => {
    ...
    expect(result).toStrictEqual({
      ...
      '--theme-primary-default-default-background': '93.12% 2.2% 266.71 / 1',
      ...
      '--theme-primary-emphasis-default-background': '82.78% 6.94% 261.37 / 1',
      ...
      '--theme-primary-interactive-default-background': '65.48% 16.74% 249.67 / 1',
      ...
      '--theme-primary-surface-default-background': '98.29% 0.59% 76.16 / 1',
