...
function isNumberDivisibleByAny(n: number | bigint, divisors: (number | bigint)[]): boolean
function isNumberDivisibleByAll(n: number | bigint, divisors: (number | bigint)[]): boolean
```
